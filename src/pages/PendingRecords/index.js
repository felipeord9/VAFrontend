...
import { findRecordsPending } from '../../services/recordService';
...
export default function PendigRecords() {
      ...
      <div className="d-flex flex-column gap-2 h-100">
        <div className="d-flex div-botons justify-content-center align-items-center bg-light rounded shadow-sm p-2 pe-2">
          <div className='d-flex flex-column w-100'>
            <label style={{fontSize: isMobile ? 15 : 22, color: 'rgba(220, 174, 47, 0.8)'}} className='d-flex justify-content-center fw-bold'>REGISTROS PENDIENTES</label>
        ...
        <TablePendingRecords records={suggestions} getAllRecords={getRecordsPending} loading={loading}/>
      </div>
    </div>
  );
}